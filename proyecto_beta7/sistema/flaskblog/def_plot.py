...
def img_plot(x_new2,y_new,file_name,fig,ax,a_2,b_2,aaa,bbb):
  ...
  #.dadadadasdasdasdasdasdasdasdasdasdadsadasdasdasdsadasdadfsdffadaddadadasdasdasdasdsaddasdadasdsadasd
    ...
    print("AGULO A:",a_angle)
    print("ANGULO B:",b_angle)
    print("ANGULO C",c_angle)
  ...
  #.dadadadasdasdasdasdasdasdasdasdasdadsadasdasdasdsadasdadfsdffadaddadadasdasdasdasdsaddasdadasdsadasd
    ...
    print("AGULO A_1:",a_angle_1)
    print("ANGULO B_1:",b_angle_1)
    print("ANGULO C_1",c_angle_1)
...
def img_finale(x_new2,y_new,file_name,fig,ax,a_2,b_2):
    ...
    titulo= nombre_archivo(file_name)
    titulo_final=titulo+'finale.png'
    path = 'static/'
    plt.savefig(os.path.join(path, titulo_final))
    return titulo_final
